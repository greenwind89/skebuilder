	...
	action: function(oObj, sAction)
	{
		...
		switch (sAction)
		{
			case 'edit':
				...
				break;
			case 'delete':
				if (confirm(oTranslations['[skebuilder:module_name].are_you_sure_this_will_delete_all_items_that_belong_to_this_category_and_cannot_be_undone']))
				{
